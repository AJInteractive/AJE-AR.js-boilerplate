...
var _canvasToImage = __webpack_require__(3);
...
document.getElementById("img-thumb").addEventListener("click", function () {
  ...
  document.getElementById("img-thumb").src = "images/old-aj" + ["e", "a"][initial] + ".jpg";
  initial = 1 - initial;
  var imgTexture = THREE.ImageUtils.loadTexture("images/old-aj" + ["e", "a"][initial] + ".jpg");
...
var arToolkitContext = new THREEx.ArToolkitContext({
  cameraParametersUrl: "https://cdn.rawgit.com/AJInteractive/AJE-AR.js-boilerplate/dfb16e8c/build/data/camera_para.dat",
  detectionMode: "mono"
});
// initialize it
...
var markerControls = new THREEx.ArMarkerControls(arToolkitContext, camera, {
  type: "pattern",
  patternUrl: "https://cdn.rawgit.com/AJInteractive/AJE-AR.js-boilerplate/dfb16e8c/build/data/patt.jazeera",
...
function takeScreenshot() {
  ...
  loadImages(sources, function (images) {
    ...
    _canvasToImage2.default.saveAsJPEG(doubleImageCanvas, 640, 480);
  });
}
